...
class FakePokemonRepository : PokemonRepository(mockk(relaxed = true)) {
    ...
    var searchResult: Result<List<PokemonListItem>> = Result.success(defaultPokemonList())
    ...
    override suspend fun searchPokemon(query: String): Result<List<PokemonListItem>> = searchResult
